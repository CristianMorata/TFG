...
const { guardarOModificarMesa, cerrarMesa, listarMesa, obtenerContadorMesas, actualizarContadorMesas, listarMesasExtra, listarTodasLasMesas, actualizarLlamadaOCuenta } = require("./funciones/mesa/mesa.js");
...
const { actualizarConfiguracion, obtenerConfiguracion, modificarCategoria, obtenerCategorias, eliminarCategoria, modificarAlergeno, obtenerAlergenos, eliminarAlergeno, listarHistorialMesas } = require("./funciones/configuracion/configuracion.js");
...
exports.actualizarLlamadaOCuenta = onRequest(actualizarLlamadaOCuenta);
...
exports.eliminarCategoria = onRequest(eliminarCategoria);
exports.modificarAlergeno = onRequest(modificarAlergeno);
exports.obtenerAlergenos = onRequest(obtenerAlergenos);
exports.eliminarAlergeno = onRequest(eliminarAlergeno);
exports.listarHistorialMesas = onRequest(listarHistorialMesas);